...
const DEFAULT_TEMPLATES: Template[] = [
    { id: '1', name: 'Boas-vindas', trigger: 'user_register', subject: 'Bem-vindo ao O Discipulo, {name}!', body: 'Ola {name}!\n\nSeja bem-vindo ao O Discipulo! Sua jornada pelas cidades biblicas comeca agora.\n\nComece jogando em Jerusalem e descubra o contexto historico das escrituras.\n\nBoa jornada!\nEquipe O Discipulo', channel: 'both', enabled: true },
    { id: '2', name: 'Cidade Completa', trigger: 'city_complete', subject: 'Parabens! Voce completou {city}!', body: 'Ola {name}!\n\nVoce completou {city} com {accuracy}% de precisao e {points} pontos!\n\nSua posicao no ranking: #{rank}\n\nContinue sua peregrinacao!', channel: 'email', enabled: true },
    { id: '3', name: 'Conquista Desbloqueada', trigger: 'achievement_unlock', subject: 'Nova conquista desbloqueada!', body: 'Ola {name}!\n\nVoce desbloqueou uma nova conquista: {achievement_name}!\n\n{achievement_description}\n\nContinue jogando para desbloquear mais!', channel: 'email', enabled: true },
    { id: '4', name: 'Desafio Semanal', trigger: 'weekly_challenge', subject: 'Novo desafio semanal disponivel!', body: 'Ola {name}!\n\nUm novo desafio semanal esta disponivel: {challenge_name}\n\n{challenge_description}\n\nRecompensa: {reward} pontos bonus\n\nAceite o desafio agora!', channel: 'both', enabled: true },
    { id: '5', name: 'Usuario Inativo', trigger: 'user_inactive_7d', subject: 'Sentimos sua falta, {name}!', body: 'Ola {name}!\n\nFaz uma semana que voce nao joga. Suas cidades biblicas estao esperando!\n\nVoce tem {points} pontos e esta na posicao #{rank}.\n\nVolte e continue sua jornada!', channel: 'both', enabled: false },
    { id: '6', name: 'Assinatura Confirmada', trigger: 'subscription_created', subject: 'Assinatura Premium confirmada!', body: 'Ola {name}!\n\nSua assinatura Premium foi confirmada com sucesso!\n\nAgora voce tem acesso a:\n- Todas as cidades\n- Conteudo exclusivo\n- Sem anuncios\n\nAproveite!', channel: 'email', enabled: true },
    { id: '7', name: 'Pagamento Falhou', trigger: 'payment_failed', subject: 'Problema com seu pagamento', body: 'Ola {name}!\n\nHouve um problema ao processar seu pagamento.\n\nPor favor, atualize seus dados de pagamento para continuar com o plano Premium.\n\nSe precisar de ajuda, entre em contato.', channel: 'both', enabled: true },
];
