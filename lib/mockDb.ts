...
const _defaultStore = {
    ...
    siteSettings: {
        hero: {
            ...
            title: 'O Discipulo',
            subtitle: 'Onde Historia e Aventura se Encontram',
            description: 'Uma jornada interativa de conhecimento biblico, geografia atual e turismo religioso. Explore as cidades que transformaram o mundo.',
            badge_text: 'As Viagens de Paulo',
            cta_primary: 'Comecar Jornada',
            cta_secondary: 'Ja tenho conta',
            stats: [{ number: '10+', label: 'Cidades' }, { number: '270+', label: 'Perguntas' }, { number: '3', label: 'Blocos' }],
        },
        cities_section: {
            label: 'Destinos Historicos',
            title: 'Explore as Cidades Biblicas',
            subtitle: 'Cada cidade guarda historias milenares esperando para serem descobertas.',
        },
        map_section: {
            image_url: '/images/map.svg',
            label: 'Viagens Missionarias',
            title: 'As Rotas do Apostolo Paulo',
            subtitle: 'Tres jornadas que transformaram o mundo. Mais de 16.000 km percorridos em 12 anos.',
            stats: [{ label: 'DISTANCIA', value: '16.000+ km' }, { label: 'DURACAO', value: '~12 anos' }, { label: 'PAISES', value: '10 visitados' }, { label: 'CIDADES', value: '50+ cidades' }],
            journeys: [
                { num: '1a', title: 'Primeira Viagem', route: 'Chipre, Turquia', date: '46-48 d.C.' },
                { num: '2a', title: 'Segunda Viagem', route: 'Grecia, Macedonia', date: '49-52 d.C.' },
                { num: '3a', title: 'Terceira Viagem', route: 'Efeso, Jerusalem', date: '53-58 d.C.' },
            ],
        },
        how_it_works: {
            label: 'Como Funciona',
            title: 'Uma experiencia unica de aprendizado',
            subtitle: 'Aprenda, compita e ganhe premios reais explorando as cidades biblicas.',
            items: [
                { icon: '📖', title: 'Aprenda', desc: 'Mergulhe em perguntas sobre contexto biblico, geografia moderna e turismo local de cada cidade historica.' },
                { icon: '⚔️', title: 'Compete', desc: 'Responda perguntas com precisao e velocidade. Suba no ranking global e desafie jogadores do mundo todo.' },
                { icon: '🏆', title: 'Ganhe', desc: 'Os melhores colocados ganham viagens reais para explorar as cidades historicas do cristianismo.' },
            ],
        },
        cta_section: {
            title: 'Pronto para Comecar sua Jornada?',
            subtitle: 'Junte-se a milhares de discipulos ao redor do mundo na maior aventura de conhecimento biblico e turismo religioso.',
